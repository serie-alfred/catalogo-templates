      ...
      <form className={styles.filterForm} method="get">
        ...
        <button type="submit" className={styles.filterButton}>
            <svg fill="none" height={24} viewBox="0 0 24 24" width={24} xmlns="http://www.w3.org/2000/svg">
              <path d="M11 4H21" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M13 19H21" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M3 19H7" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M3 11.5H13" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M3 4H5" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M19 11.5H21" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M9.5 2C9.0341 2 8.8011 2 8.6173 2.07612C8.3723 2.17761 8.1776 2.37229 8.0761 2.61732C8 2.80109 8 3.03406 8 3.5V4.5C8 4.96594 8 5.19891 8.0761 5.38268C8.1776 5.62771 8.3723 5.82239 8.6173 5.92388C8.8011 6 9.0341 6 9.5 6C9.9659 6 10.1989 6 10.3827 5.92388C10.6277 5.82239 10.8224 5.62771 10.9239 5.38268C11 5.19891 11 4.96594 11 4.5V3.5C11 3.03406 11 2.80109 10.9239 2.61732C10.8224 2.37229 10.6277 2.17761 10.3827 2.07612C10.1989 2 9.9659 2 9.5 2Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M11.5 17C11.0341 17 10.8011 17 10.6173 17.0761C10.3723 17.1776 10.1776 17.3723 10.0761 17.6173C10 17.8011 10 18.0341 10 18.5V19.5C10 19.9659 10 20.1989 10.0761 20.3827C10.1776 20.6277 10.3723 20.8224 10.6173 20.9239C10.8011 21 11.0341 21 11.5 21C11.9659 21 12.1989 21 12.3827 20.9239C12.6277 20.8224 12.8224 20.6277 12.9239 20.3827C13 20.1989 13 19.9659 13 19.5V18.5C13 18.0341 13 17.8011 12.9239 17.6173C12.8224 17.3723 12.6277 17.1776 12.3827 17.0761C12.1989 17 11.9659 17 11.5 17Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              <path d="M14.5 9.5C14.0341 9.5 13.8011 9.5 13.6173 9.57612C13.3723 9.67761 13.1776 9.87229 13.0761 10.1173C13 10.3011 13 10.5341 13 11V12C13 12.4659 13 12.6989 13.0761 12.8827C13.1776 13.1277 13.3723 13.3224 13.6173 13.4239C13.8011 13.5 14.0341 13.5 14.5 13.5C14.9659 13.5 15.1989 13.5 15.3827 13.4239C15.6277 13.3224 15.8224 13.1277 15.9239 12.8827C16 12.6989 16 12.4659 16 12V11C16 10.5341 16 10.3011 15.9239 10.1173C15.8224 9.87229 15.6277 9.67761 15.3827 9.57612C15.1989 9.5 14.9659 9.5 14.5 9.5Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
            
            Filtrar
            
            <svg fill="none" height={24} viewBox="0 0 24 24" width={24} xmlns="http://www.w3.org/2000/svg">
              <path d="M10 16L14 12L10 8" stroke="#F5F5F5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
        </button>
      </form>
