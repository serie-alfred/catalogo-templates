  ...
  header: {
    ...
    items: [
      ...
      { id: "05", selection: "header", key: "hdr05mnu6xj1", image: "", mobile: "", title: "Header Template 5", description: "Header claro (SÉRIE//A) com barra de serviço, busca, wordmark e navegação por categorias", template: "5", pagina: ["common"], component: "Header05", path: "organisms/Header05", platforms: ['VTEX'], backgroundVars: ["primary", "secondary"], variablesSchema: [
        ...
        { cssVar: "--header-service-text", label: "Texto da barra de serviço", type: "color", default: "#ffffff", group: "Header" },
      ...
      { id: "06", selection: "header", key: "hdr06frc1a2b", image: "", mobile: "", title: "Header Template 6", description: "Header Ferracini: top-bar em slider, mega-menu por hover, busca e ícones (favoritos, lojas, conta, sacola)", template: "6", pagina: ["common"], component: "Header06", path: "organisms/Header06", platforms: ['VTEX'], backgroundVars: ["primary", "secondary"], variablesSchema: [
        ...
        { cssVar: "--header-topbar-text", label: "Texto da barra superior", type: "color", default: "#3f3f40", group: "Barra superior", inheritsLabel: "cor de texto secundária" },
        ...
        { cssVar: "--header-accent", label: "Cor de destaque (hover, SALE, badge, logo)", type: "color", default: "#c0121c", group: "Destaque", inheritsLabel: "cor secundária da marca" },
        { cssVar: "--header-font", label: "Fonte do header", type: "font", default: "'Fabriga', sans-serif", group: "Tipografia", inheritsLabel: "fonte primária" },
      ] },
    ],
  },
  spot: {
