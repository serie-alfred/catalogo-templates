...
export const LAYOUTS: Layouts = {
  ...
  ruler: {
    ...
    items: [
      { id: "01",selection: "ruler", key:"bnf01y0z1a2b", image: "benefitsBar/desktop/benefitsBar_01.png", mobile: "benefitsBar/mobile/benefitsBar_01_m.png", title: "Barra de benefícios", description: "Benefícios", template: "1", pagina: ["home"], component: "Ruler01", platforms: ['Tray', 'Shopify', 'Wake'] },
      { id: "02",selection: "ruler", key:"bnf01y0z1a2b", image: "benefitsBar/desktop/benefitsBar_01.png", mobile: "benefitsBar/mobile/benefitsBar_01_m.png", title: "Barra de benefícios", description: "Benefícios 2", template: "2", pagina: ["home"], component: "Ruler02", platforms: ['Tray', 'Shopify', 'Wake'] },
    ],
  },
  grid: {
  ...
  bannerSide: {
    ...
    items: [
      ...
      { id: "02",selection: "banner-side", key:"grd01g6h7i8j", image: "gridBanner/desktop/gridBanner_01.png", mobile: "gridBanner/mobile/gridBanner_01_m.png", title: "Grid de banners", description: "Seção de banners", template: "2", pagina: ["home"], component: "BannerSide02", platforms: ['Tray', 'Shopify', 'Wake', 'VTEX'] },
