...
export const LAYOUTS: Layouts = {
  ...
  categories: {
    ...
    items: [
      { id: "01", selection: "categories", key: "cat01lk3ndkl", image: "", mobile: "", title: "Carrossel de Categorias Template 1", description: "Descrição Template 1", template: "1", pagina: ["home"], component: "Categories01",path: "molecules/Categories01", platforms: ['Tray', 'Wake', 'VTEX'], backgroundVars: [] },
  ...
  banner: {
    name: "Banners",
    items: [
      { id: "01", selection: "banner-main", key: "ban01m1k3nq2", image: "", mobile: "", title: "Banners Template 1", description: "Descrição Template 1", template: "1", pagina: ["home"], component: "BannerMain01",path: "organisms/BannerMain01", platforms: ['Tray', 'Wake', 'VTEX'], backgroundVars: ["primary"] },
  ...
  ruler: {
    ...
    items: [
      { id: "01", selection: "ruler", key: "bnf01lm3a894", image: "", mobile: "", title: "Regua de benefícios Template 1", description: "Descrição Template 1", template: "1", pagina: ["home"], component: "Ruler01",path: "molecules/Ruler01", platforms: ['Tray', 'Wake', 'VTEX'], backgroundVars: ["secondary"] },
  ...
  grid: {
    ...
    items: [
      { id: "01", selection: "banner-grid", key: "grd01qw09er8", image: "", mobile: "", title: "Grid de banners Template 1", description: "Descrição Template 1", template: "1", pagina: ["home"], component: "BannerGrid01",path: "molecules/BannerGrid01", platforms: ['Tray', 'Wake', 'VTEX'], backgroundVars: [] },
    ],
  },
  bannerSide: {
    name: "Banner Side",
  ...
  showcase: {
    name: "Vitrines",
    items: [
      { id: "01", selection: "showcase", key: "vtr01cm487ha", image: "", mobile: "", title: "Título Template 1", description: "Descrição Template 1", template: "1", pagina: ["home"], component: "Showcase01",path: "organisms/ProductShelfCustom01", platforms: ['Tray', 'Wake', 'VTEX'], backgroundVars: ["primary"] },
      ...
      { id: "07", selection: "showcase", key: "vtr02mq91m48", image: "", mobile: "", title: "Título Template 7", description: "Descrição Template 7", template: "7", pagina: ["home"], component: "Showcase07", platforms: ['Tray', 'Wake'], backgroundVars: ["primary"] },
